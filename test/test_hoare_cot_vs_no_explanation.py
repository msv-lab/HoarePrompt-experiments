...
from src.experimentation.complete.complete import analyze_code_with_precondition_cot
...
hoare_cot_correctness_str, hoare_cot_response = check_program(specification, replaced_code, None, MODEL, TEMPERATURE,
                                                              hoare_cot_post)
no_explanation_correctness_str, no_explanation_response = check_program(specification, replaced_code, None, MODEL,
                                                                        TEMPERATURE)
