...
def main(data: dict, config: dict, logger, model, datafile):
    ...
    columns = ["Task ID", "Dataset", "model_created", "model_run", "description", "Code", "Test Result", "Post", "original correctness", "confidence1", "confidence2",  "correctness1", "correctness2", "data file"]
    ...
    for task_data in data:
        ...
        detail_log_directory = logger.log_dir  / task_id/ f"{task_id}_confidence" / model_created
        ...
        for i in range(1, 6):
            try:
                ...
                result1, confidence1, result2, confidence2=assess(description, code, task_id, config, detail_log_directory, None)
            ...
            result = {
                ...
                "correctness1": result1,
                "correctness1": result2,
                "data file": datafile,
            }
